...
import { Heart, Mail, Phone, MapPin, Apple } from 'lucide-react';
  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/resources" className="text-gray-300 hover:text-white">Find Food</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/food-banks" className="text-gray-300 hover:text-white">Food Banks</Link></li>
              <li><Link to="/meal-programs" className="text-gray-300 hover:text-white">Meal Programs</Link></li>
              <li><Link to="/assistance-programs" className="text-gray-300 hover:text-white">Assistance Programs</Link></li>
              <li><Link to="/nutrition" className="text-gray-300 hover:text-white">Nutrition Resources</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">123 Hope Street, Anytown, USA</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-4 text-center text-gray-300 flex items-center justify-center">
          <Heart className="h-4 w-4 text-red-400 mr-1" />
          <span>Made with love for communities in need</span>
        </div>
      </div>
    </footer>
  );
